...
public class ProfilesData
{
  ...
  public ProfilesData(ImageProcessor ip, String name, int peakWidth, double stringency)
  {
    this.name = name;
  ...
  private Line[] generateRoi()
  {
    ...
    for (int j = 0; j < 10; j++) {
      lines[(10 + j)] = new Line(0.0D, (0.5D + j) * this.height / 10.0D, this.width, 
        (0.5D + j) * this.height / 10.0D);
    }
    return lines;
  }
  ...
  private void populatePeaks(double[][] values, int peakWidth, double stringency)
  {
