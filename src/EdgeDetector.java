 ...
 * 
 * Based on the algorithm by Chalfoun et al
 * http://www.nist.gov/itl/math/hpcvg/upload/Chalfounratio.pdf
 * 
 * Modified to use values obtained by the peak median and the 70% percentile peak intensity values
 * and an arbitrary ratio set up in the initial screen.
 * 
 */
...
public class EdgeDetector {
	...
	public void detect(double peakMedian, double background, double ratio) {
		...
		ImagePlus imp = new ImagePlus(this.name + " edges - ratio: " + ratio,
				stack);
		imp.show();
	}
}
